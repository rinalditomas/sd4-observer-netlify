...
export default function Header() {
  ...
  const { lastUpdate, selectedHost } = store;
    ...
    <div className="bg-gray-50 w-full">
      ...
      <div className="mx-auto px-4 text-center sm:px-6  lg:px-8 mt-4">
        <div className=" flex justify-between items-center  mb-4 px-4">
          ...
          <div className="bg-white rounded flex w-fit h-fit py-2 px-2 divide-x divide-gray-200 shadow ">
            <div className="flex items-center justify-center py-1 px-2">
              <h1 className={" text-green-600"}>API</h1>
              <div className={"bg-green-600 h-4 w-4 rounded-full ml-3"}></div>
            </div>
            <div className="flex items-center justify-center py-1 px-2">
              <h1 className="text-gray-400 ">Errors</h1>
              <h1 className=" text-gray-400 ml-3">0</h1>
            </div>
